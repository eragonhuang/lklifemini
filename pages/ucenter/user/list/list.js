...
Page({
  ...
  getMyForum: function () {
    ...
    util.request(api.MyListUrl,{ token:token,type:type,pageIndex:pageIndex,pageSize:pageSize },"POST").then(function (res) {
      if (res.ret === 0) {
  ...
  onLoad: function (options) {
    ...
    type = (type == "")?1:type;
    var navList = [{"id":0,"name":"收藏"},{"id":1,"name":"我的发布"},{"id":2,"name":"我的评论"},{"id":3,"name":"我的点赞"}];
    this.setData({
      navList: navList,
      type: type
    });
